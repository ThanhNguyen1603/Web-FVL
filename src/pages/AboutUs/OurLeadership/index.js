...
const OurLeadership = () => {
    ...
    const leadershipList = [
        ...
        { url: PhuongTranImg, name: 'Christa Tran', jobTitle: 'Operations Manager ', decription: "Christa Tran is an Operations Manager at Transcend People & First Virtue, with a decade of experience driving the company’s success. She has played a key role in fostering FV's positive culture and has made significant contributions on completing data and research projects. Christa earned her Bachelor’s degree in Corporate Finance from Customs Finance College in Ho Chi Minh City, Vietnam.", decription2: "Outside of work, Christa enjoys quality time with her children, listening to music, and reading stories.", },
