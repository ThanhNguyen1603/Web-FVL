...
const OurLeadership = () => {
    ...
    const leadershipList = [
        ...
        { url: SenNguyenImg, name: 'Lianna Nguyen', jobTitle: 'HR Director', decription: "Bringing in  16 years of experience, Lianna played a big role on both TPL and FVL operational success. As an HR Manager, her positive work culture is instrumental in achieving our business goals by streamlining our HR processes and supporting our leadership team.", decription2: "In her free time, she loves to spend time with her family.", },
